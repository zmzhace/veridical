...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'settings', element: <CapabilitiesPage /> },
      { path: 'capabilities', element: <Navigate to="/settings" replace /> },
      ...
      { path: 'tasks', element: <SessionsPage /> },
      { path: 'sessions', element: <Navigate to="/tasks" replace /> },
